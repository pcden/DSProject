...
icon = Image.open("yst.png")
st.set_page_config(page_title="Data Science Project | By Prasanna",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This app is created by Prasanna!*"""})
...
api_key = "AIzaSyCJpxRyUXBNLJPoE5ylpu87W8wdYtiQ4E4"
